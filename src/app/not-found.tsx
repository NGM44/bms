...
//             <p className="text-base font-semibold text-primary-800">404</p>
...
//               <Link
//                 href="/dashboard"
//                 className="rounded-md bg-primary-800 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-300"
//               >
//                 Go back home
//               </Link>
//             </div>
