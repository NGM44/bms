      ...
      {/* <header className="absolute inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <Link
              href="/"
              className="text-primary-800 font-bold text-lg -tracking-tight -m-1.5 p-1.5"
            >
              Vayuguna
            </Link>
          </div>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">Vayuguna</span>
                <img
          ...
          <div className="mx-auto max-w-7xl px-6 py-4 lg:flex lg:items-center lg:gap-x-10 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                ...
                comprehensive range of pollutants – including AQI, CO2, PM1,
        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 shadow-2xl sm:rounded-3xl sm:px-24 xl:py-32  mx-4 rounded-md">
            ...
            <p className="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">
              ...
              the numerous air quality parameters.
            </p>
